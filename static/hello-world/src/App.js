  ...
  useEffect(() => {
    ...
    invoke("getConfig")
      ...
      .catch((error) => {
        ...
        setStatus("ready"); // Still show UI even if config load fails
      });
  }, []);
    ...
    >
      ...
      >
        ...
        <div style={{ marginBottom: "15px" }}>
          ...
          >
            <option value="gpt-4">GPT-4 (Best accuracy, higher cost)</option>
        ...
        <div style={{ marginBottom: "20px" }}>
          ...
          >
            <input
              ...
              onChange={(e) => handleChange("autoPriority", e.target.checked)}
              style={{ marginRight: "12px", transform: "scale(1.2)" }}
            />
            <div>
              <strong style={{ fontSize: "16px" }}>🏷️ Auto-Set Priority</strong>
              <div
                style={{ fontSize: "14px", color: "#666", marginTop: "4px" }}
              >
      ...
      >
        <h3 style={{ marginTop: "0", color: "#0052cc" }}>📊 Current Status</h3>
        <div
          style={{
            display: "grid",
        ...
        >
          ...
          <div
            style={{
              padding: "12px",
              backgroundColor: config.enableSuggestions ? "#d4edda" : "#f8d7da",
              borderRadius: "6px",
              textAlign: "center",
            }}
          >
      ...
      >
        ...
        <ul style={{ marginBottom: "0", color: "#0c5460" }}>
          <li>
            <strong>Smart Assignment:</strong> AI analyzes content and suggests
            the best team member
          </li>
          <li>
            <strong>Priority Intelligence:</strong> Evaluates urgency and impact
            to set priority
          </li>
          <li>
          ...
          <li>
            <strong>Confidence Control:</strong> Only applies suggestions above
            your threshold
          </li>
        </ul>
      </div>
